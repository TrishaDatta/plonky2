...
/*static H_ORIG : usize = 500;
static W_ORIG : usize = 500;
static H_NEW : usize = 300;
static W_NEW : usize = 300;*/
...
fn main() -> Result<()> {
    ...
    for i in 0..H_NEW {
        for j in 0..W_NEW {
            ...
            let a = w_r_targets[y_l][x_l];
            let b = w_r_targets[y_l][x_h];
            let c = w_r_targets[y_h][x_l];
            let d = w_r_targets[y_h][x_h];
